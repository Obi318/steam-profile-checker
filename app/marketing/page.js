...
export default function HomePage() {
  const DEFAULT_PROFILE_URL = "https://steamcommunity.com/id/datguylorik11";
  ...
  return (
    <main className="min-h-screen text-[15px] selection:bg-white/20 relative overflow-hidden bg-black">
        ...
        <div className="glass-card rounded-[32px] p-1 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)]">
          <div className="rounded-[28px] bg-black/40 p-6 sm:p-10 border border-white/[0.03]">
            ...
            <div className="mb-8 space-y-6">
              ...
              {err ? (
                <div className="p-4 rounded-xl bg-red-500/10 border border-red-500/20 text-red-200 text-sm font-medium flex gap-3 items-center">
